...
(function() {
    ...
    var Utils = {
        ...
        getPlugin: function(name) {
            ...
            if (plugin) {
                if (name === 'fb-messenger-checkbox') {
                    var auto_hide_days = +plugin.getAttribute('auto_hide_days')
                    var already_checked = Utils.getCookie('bothub_checkbox_checked')

                    if (auto_hide_days > 0 && auto_hide_days <=15 && already_checked) {
                        return null
                    }
                }
        ...
        loadFacebookSdk: function() {
            ...
            var base_url = 'https://connect.facebook.net/' + language + '/'
            facebook_script.src = base_url + (debug ? 'sdk/debug' : 'sdk') + '.js';
            if (window['bothub-customerchat']) {
                facebook_script.src = base_url + 'sdk/xfbml.customerchat.js';
            }
            ...
            window.fbAsyncInit = function() {
                ...
                FB.Event.subscribe('messenger_checkbox', function(e) {
                    ...
                    if (e.event === 'rendered') {
                        ...
                        var checkbox = document.getElementById('bothub-messenger-checkbox')
                        var hideDays = +checkbox.getAttribute('auto_hide_days')
                        if (checkbox && checkboxState === 'checked' && hideDays) {
                            if (hideDays <= 15) {
                                Utils.setCookie('bothub_checkbox_checked', 'true', hideDays)
                            }
                        }
